...
export const metadata: Metadata = { title: "Deine Rahmen-Empfehlungen", description: "Persönlich gewichtete Bilderrahmen-Empfehlungen mit transparentem Match-Score.", robots: { index: false, follow: true } };
